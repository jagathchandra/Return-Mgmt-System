...
namespace ComponentProcessingAPIProject.Models
{
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<LoginDetail>(entity =>
            {
                entity.HasKey(e => e.Username)
                    .HasName("PK__LoginDet__536C85E5EC40EFA8");
            ...
            modelBuilder.Entity<ProcessDetail>(entity =>
            {
                entity.HasKey(e => e.ContactNumber)
                    .HasName("PK__ProcessD__570665C7C7252B19");
                ...
                entity.HasOne(d => d.NameNavigation)
                    ...
                    .HasConstraintName("FK__ProcessDet__Name__52593CB8");
            });
